...
import ru.bingosoft.taxInspector.util.Const.Location.DESIRED_ACCURACY
import ru.bingosoft.taxInspector.util.Const.Location.MINIMAL_DISTANCE
import ru.bingosoft.taxInspector.util.Const.Location.MINIMAL_TIME
import ru.bingosoft.taxInspector.util.Const.Location.TARGET_POINT
import ru.bingosoft.taxInspector.util.Const.Location.USE_IN_BACKGROUND
import ru.bingosoft.taxInspector.util.Const.Location.ZOOM_LEVEL
import ru.bingosoft.taxInspector.util.Const.RequestCodes.PERMISSION
